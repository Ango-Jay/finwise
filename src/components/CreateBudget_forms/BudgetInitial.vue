...
watchEffect(()=>{
    if(state.initialBalanceFormatted && initialBalanceFormattedFieldType.value === "number"){
...
watchEffect(()=>{
  ...
  state.initialBalanceFormatted =  `${parseFloat(state.initialBalance.replace(/,/g, "")).toLocaleString(
    "en-US",
    {
      style: "decimal",
    ...
    <div class="w-full mt-[3rem] px-6">
      ...
      <div class="my-4 flex flex-col relative">
        ...
        >
                 <div class="w-full relative mt-4">
                        <div class="flex  items-center w-full bg-backdrop  outline-0 rounded-2xl p-4">
                          <p
      ...
      <div class="my-4 flex flex-col relative">
           ...
           <input
              ...
              :class="{'bg-transparent' : initialBalanceFormattedFieldType === 'text'}"
  ...
  {{ state.initialBalanceFormatted }}
    ...
    <div class="my-4 flex flex-col relative">
            <label
              ...
              >Description</label
            >
            <textarea name="description" class="bg-backdrop rounded-2xl text-light p-4"  v-model="state.description"></textarea>
          </div>
